set top_module sram_64b_w8 
set homedir "$env(PROJECT_RTL_DIR)"  ;# 去識別:原為課程伺服器路徑
set rtlPath "$homedir/verilog/sram"

# Target library
set target_library $env(COURSE_PDK_DB)/tcbn65gpluswc.db  ;# 去識別:PDK 住課程伺服器,不隨 repo 發布 
set synthetic_library /software/nonrdist64/dc-2015.06-SP4/libraries/syn/dw_foundation.sldb
...
#analyze -format sverilog -lib WORK fullchip.v
#analyze -format sverilog -lib WORK core.v
#analyze -format sverilog -lib WORK DW_div.v
#analyze -format sverilog -lib WORK DW_div_pipe.v
#analyze -format sverilog -lib WORK bus_sync.v
#analyze -format sverilog -lib WORK norm.v
#analyze -format sverilog -lib WORK sync.v
#analyze -format sverilog -lib WORK sfp_row.v
#analyze -format sverilog -lib WORK mac_col.v
#analyze -format sverilog -lib WORK mac_16in.v
#analyze -format sverilog -lib WORK mac_8in.v
#analyze -format sverilog -lib WORK mac_array.v
#analyze -format sverilog -lib WORK sram_w16.v
#analyze -format sverilog -lib WORK ofifo.v
#analyze -format sverilog -lib WORK fifo_serial_parallel.v
#analyze -format sverilog -lib WORK fifo_depth64.v
#analyze -format sverilog -lib WORK fifo_depth16.v
#analyze -format sverilog -lib WORK fifo_mux_16_1.v
#analyze -format sverilog -lib WORK fifo_mux_8_1.v
#analyze -format sverilog -lib WORK fifo_mux_4_1.v
#analyze -format sverilog -lib WORK fifo_mux_2_1.v
analyze -format verilog -lib WORK sram_64b_w8.v
...
read_sdc $env(PROJECT_SDC_DIR)/sram_64b_w8.sdc  ;# 去識別
